/**
 * @zakkster/lite-signal v1.8.0-alpha.7
...
export function createRegistry(config) {
     ...
     * typically across an async boundary. Shipped in 1.5.0-beta.2, carried
     * forward unchanged into 1.6 / 1.7 / 1.8.
     *
     ...
     * cascade-dispose when the owner re-runs or is disposed. Shipped in
     * 1.5.0-beta.2, carried forward unchanged into 1.6 / 1.7 / 1.8.
     *
    ...
    return {signal, computed, effect, signalBox, computedBox, dispose, batch, flush, untrack, createRoot, getOwner, runWithOwner, createScope, onCleanup, stats, destroy, isTracking, hasObservers, observeObservers, forEachObserver, forEachSource, forEachOwned, ownerOf, nodeId, describe, onGraphMutation};
}
