/**
 * @zakkster/lite-signal v1.7.0-alpha.6
 * --------------------
 ...
 * S0b ledger #6 verdict (per-call closure-var loads are forbidden -- a hoisted
...
export function createRegistry(config) {
     ...
     * forward unchanged into 1.6 and 1.7.
     *
     ...
     * 1.5.0-beta.2, carried forward unchanged into 1.6 and 1.7.
     *
