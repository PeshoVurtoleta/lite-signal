/**
 * @zakkster/lite-signal v1.6.0-rc.1
 * --------------------
...
export function createRegistry(config) {
     ...
     * 1.5.0-beta.2, carried forward unchanged into 1.6.
     *
    ...
    return {signal, computed, effect, signalBox, computedBox, dispose, batch, untrack, createRoot, getOwner, runWithOwner, createScope, onCleanup, stats, destroy, isTracking, hasObservers, observeObservers, forEachObserver, forEachSource, forEachOwned, ownerOf, nodeId, describe, onGraphMutation};
}
