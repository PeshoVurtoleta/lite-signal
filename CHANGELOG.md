...
## [1.10.0-preview.1] -- 2026-09-20

Verification + docs increment over `1.10.0-preview`; **no engine change past the
...
- `test/38-perf-gate.test.mjs` + `npm run test:gate`
  (`node --expose-gc --max-semi-space-size=4 --test test/38-perf-gate.test.mjs`),
