...
## [1.9.0-alpha.1] -- 2026-09-20

Verification + docs increment over `1.9.0-alpha`; **no engine change past the
...
- `test/37-perf-gate.test.mjs` + `npm run test:gate`
  (`node --expose-gc --max-semi-space-size=4 --test test/37-perf-gate.test.mjs`),
