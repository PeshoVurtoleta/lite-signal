...
export function createRegistry(config) {
    ...
    function allocateLink(source, target) {
        ...
        // Deduplication scan: Iterates the valid prefix to prevent duplicates.
    ...
    function createNode(value, flags) {
        ...
        // Wire into Owner Context
        node.owner = currentObserver;
        node.prevOwned = null;
        node.nextOwned = null;
        node.firstOwned = null;
        if (currentObserver !== null) {
            node.nextOwned = currentObserver.firstOwned;
            if (currentObserver.firstOwned !== null) {
                currentObserver.firstOwned.prevOwned = node;
            }
            currentObserver.firstOwned = node;
        }
