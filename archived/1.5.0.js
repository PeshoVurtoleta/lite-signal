...
export function createRegistry(config) {
    ...
    function stats() {
        return {
            ...
            // Derive: allocationRate = ΔtotalAllocations/Δt; poolReuseRate =
    ...
    return {signal, computed, effect, signalBox, computedBox, dispose, batch, untrack, onCleanup, stats, destroy, isTracking, hasObservers, observeObservers, forEachObserver, forEachSource, forEachOwned, ownerOf, nodeId, describe, onGraphMutation};
}
