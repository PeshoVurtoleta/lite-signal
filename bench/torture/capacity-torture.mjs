...
/* -- 9. grow mode still has a ceiling: the 16x link limit ------------------- */
{
    ...
    // against 1.11.0 Signal.js:492 `const maxLinkLimit = currentLinkCapacity * 16;`
    // and :670 `if (linkPool.length >= maxLinkLimit) throw new CapacityError("links", maxLinkLimit);`).
