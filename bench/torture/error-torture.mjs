 ...
 *
 * (Confirmed against 1.8.0 Signal.js: :901 buffer append (flushErrorBuffer),
 * :909-910 finally clear on abnormal exit, :914-924 single re-throw / AggregateError
 * aggregation. The per-effect buffering, exact-order aggregation and buffer drain
 * are byte-identical to 1.4.4 -- no behavioral divergence observed on 1.8.0.)
 *
