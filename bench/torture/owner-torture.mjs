 ...
 *
 * 1.6.0 NOTE: this scenario is createScope-based and SKIPPED on 1.4.4 (no
 * createScope). 1.6.0 ships createScope + getOwner + runWithOwner, so it RUNS
 * NATIVELY here -- no SKIP. Every scenario (1-7) was confirmed against 1.6.0's
